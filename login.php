...
<!-------------------------------------------Content----------------------------------------------------->
	...
	<div style = "text-align: center">	
		<h2><br>Log In</h2><br>
		<p>As </p>
		<a href= "loginstudent.php"><button style = "padding: 18px;font-size: 18px;">Student</button></a><br><br><br>         
		<a href= "loginadmin.php"><button style = "padding: 18px;font-size: 18px;">Admin</button></a><br><br><br><br><br>
		Dont have an account yet?
		<a href ="signup.php" style="color: blue"><u>Sign Up</u></a>
