...
<!-------------------------------------------Content----------------------------------------------------->
	...
	<?php include_once('signuperrors.php'); ?>	
		<form action = "pwstudent.php" method = "post" class="w3-padding-64 w3-center">
			Student Matriculation No.:<br><input type = "text" name = "matno" value = "<?php echo $_SESSION["matno"]?>" required><br><br>
			Initial Password:<br><input type = "password" name = "pw1" required><br><br>
			Confirm Initial Password:<br><input type = "password" name = "pw2" required><br><br>
			New Password:<br><input type = "password" name = "npw" required><br><br>
			Confirm New Password:<br><input type = "password" name = "npw1" required><br><br><br><br>
			<input type = "submit" name = "cps" value = "Confirm">
		</form><br><br><br><br>
