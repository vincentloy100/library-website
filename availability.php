...
<?php
	...
	echo '<br><br><div style="text-align:center;"><h1>Books Availability</h1>
			<br>
			...
			<input type="radio" name="sort" value="available">Availability&emsp;
			
			<input type="submit" name="sortform" value="Sort">
			</div>
			</form>
			<br><br>
			<p style="text-align:center;">**The last updated date indicates where the book is last updated on its availability upon issued or return by other students.</p>
			<div class = "table">
