...
<?php
	...
	echo '<br><br><div style="text-align:center;"><h1>Book List</h1>
			<br>
			<form action="list.php" method = "post">
			Sort by? &emsp;
			<input type="radio" name="sort" value="id" checked>ID&emsp;
			<input type="radio" name="sort" value="name">Name&emsp;
			<input type="radio" name="sort" value="author">Author&emsp;
			<input type="radio" name="sort" value="price">Price&emsp;
			<input type="radio" name="sort" value="availability">Availability&emsp;
			...
			if (isset($_SESSION['faildelete'])): 
				echo '<div class="error">';
				echo $_SESSION['faildelete'];
				unset ($_SESSION['faildelete']);
				echo '</div>';
			endif;
	...
	echo'<div class = "table">
			...
			<tr><br>
				...
				<th class = "bla">Book Name</th>
				<th class = "bla">Book Author</th>
				<th class = "bla">Book Price</th>
				<th class = "bla">Shelf</th>
				<th class = "bla">Row</th>
				<th class = "bla">Availability</th>
				
				<th class = "bla">Edit/Delete</th>
			</tr>';
	if(isset($_POST['sortform'])){
		...
		else if ($sortt=='available'){
			$query = "SELECT * FROM books ORDER BY available";
		}
		...
		while($row = mysqli_fetch_array($r)){
			echo "<tr>
				...
				<td><br>{$row['price']}<br><br></td>
				<td><br>{$row['shelf']}<br><br></td>
				<td><br>{$row['row']}<br><br></td>
				<td><br>{$row['availability']}<br><br></td>
				
				<td><a href=\"edit.php?id={$row['id']},name={$row['name']},author={$row['author']},price={$row['price']},shelf={$row['shelf']},row={$row['row']}\"> <img src=\"images/edit.png\" width=\"25\" height=\"27\"></a>
				<a href=\"delete.php?id={$row['id']}\"> <img src=\"images/delete.png\" width=\"25\" height=\"27\"> </a></td>
				</tr>";		
		}
