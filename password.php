...
<!-------------------------------------------Content----------------------------------------------------->
	...
	<div style = "text-align: center">	
		<h2><br>Change Password</h2><br>
		<p>For </p>
		<a href= "pwstudent.php"><button style = "padding: 18px;font-size: 18px;">Student</button></a><br><br><br>         
		<a href= "pwadmin.php"><button style = "padding: 18px;font-size: 18px;">Admin</button></a><br><br><br><br><br>
	</div>
	<br><br>
