...
<!-------------------------------------------Content----------------------------------------------------->
	...
	<h1><br>Sign Up</h1><br>
	<?php include_once('signuperrors.php'); echo "<br>";?>
		<form action = "signup.php" method = "post" class="w3-padding-64 w3-center">
			Student Name:<br><input type = "text" name = "name" required><br><br>
			Student Matriculation No.:<br><input type = "text" name = "id" placeholder = "eg. P17008527" required><br><br>
			Course Code:<br><input type = "text" name = "course" placeholder = "eg. DICTN" required><br><br>
			Password:<br><input type = "password" name = "pw1" required><br><br>
			Confirm Password:<br><input type = "password" name = "pw2" required><br><br><br>
			<input type = "submit" name = "su" value = "Sign Up"><br><br>
		</form><br>
		**Students will be logged in automatically upon successful sign up.<br><br><br><br>
		Already have an account?
		<a href ="login.php" style="color: blue"><u>Log In</u></a><br><br><br>
