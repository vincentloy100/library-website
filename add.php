...
<!-------------------------------------------Content----------------------------------------------------->
	...
	<form action="add.php" method="post">
				<p style = "text-align: right; padding-right:400px">Book ID: <input type="text" name="bid" placeholder="eg. 10001" required><br><br></p>
				<p style = "text-align: right; padding-right:400px">Book Name: <input type="text" name="bname" required><br><br></p>
				<p style = "text-align: right; padding-right:400px">Book Author: <input type="text" name="bauthor" required><br><br></p>
				<p style = "text-align: right; padding-right:400px">Book Price (RM): <input type="text" name="bprice" required><br><br></p>
				<p style = "text-align: right; padding-right:400px">Book Location (shelf): <input type="text" name="bshelf" required><br><br></p>
				<p style = "text-align: right; padding-right:400px">(row): <input type="text" name="brow" required><br><br></p>
				<p style = "text-align: center;">Availability:&emsp; <input type="radio" name="bavailable" value="Available" checked>Available<br><br></p>

				<input type="submit" name="add" value="Confirm">
				<br><br><br>
			</form>

		<br><a href = "add.php"><b><i>Refresh</i></b></a><br>
