...
<!-------------------------------------------Content----------------------------------------------------->
	...
	<?php include_once('signuperrors.php'); echo"<br>";?>	
		<form action = "loginstudent.php" method = "post" class="w3-padding-64 w3-center">
			Student Matriculation No.:<br><input type = "text" name = "id" required><br><br>
			Password:<br><input type = "password" name = "pw1" required><br><br><br><br>
			<input type = "submit" name = "sis" value = "Log In">
		</form><br>
		
		<a href ="login.php"><button>Back</button></a><br><br><br>
		**If initial password has been forgotten, please approach any of our librarian admins for password retrieval.
		<br><br><br><br><br><br>
