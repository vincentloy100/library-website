...
<!-------------------------------------------Content----------------------------------------------------->
	...
	<h1><br>Change Password</h1><br>
	<?php include_once('signuperrors.php'); ?>	
		<form action = "pwadmin.php" method = "post" class="w3-padding-64 w3-center">
			Admin ID:<br><input type = "text" name = "aid" required><br><br>
			Initial Password:<br><input type = "password" name = "opw1" required><br><br>
			Confirm Initial Password:<br><input type = "password" name = "opw2" required><br><br>
			New Password:<br><input type = "password" name = "npw1" required><br><br>
			Confirm New Password:<br><input type = "password" name = "npw2" required><br><br><br><br>
			<input type = "submit" name = "cpa" value = "Confirm">
		</form><br>
		
		<a href ="password.php"><button>Back</button></a><br><br>
		<br><br>
