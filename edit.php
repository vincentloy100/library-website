...
<!-------------------------------------------Content----------------------------------------------------->
	...
	<form action="list.php" method="post">
				<h1><br>Edit Book Details</h1><br>
				<p style = "text-align: right; padding-right:400px">Book ID: <input type="text" name="ebid" value = "<?php echo $_GET['id'];?>" required><br><br></p>
				<p style = "text-align: right; padding-right:400px">Book Name: <input type="text" name="ebn" value = "<?php echo $_GET['name'];?>"required><br><br></p>
				<p style = "text-align: right; padding-right:400px">Book Author: <input type="text" name="eba" value = "<?php echo $_GET['author'];?>"required><br><br></p>
				<p style = "text-align: right; padding-right:400px">Book Price: <input type="text" name="ebp" value = "<?php echo $_GET['price'];?>"required><br><br></p>
				<p style = "text-align: right; padding-right:400px">Book Location (shelf): <input type="text" value = "<?php echo $_GET['shelf'];?>"name="ebs" required><br><br></p>
				<p style = "text-align: right; padding-right:400px">(row): <input type="text" name="ebr" value = "<?php echo $_GET['row'];?>"required><br><br></p>

				<input type="submit" name="edit" value="Confirm">
				<br><br><br>
			</form>

		<br><a href = "edit.php"><b><i>Refresh</i></b></a><br>
