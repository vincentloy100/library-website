...
<!-------------------------------------------Content----------------------------------------------------->
	...
	<?php include_once('signuperrors.php'); echo "<br>";?>	
		<form action = "loginadmin.php" method = "post" class="w3-padding-64 w3-center">
			Admin ID:<br><input type = "text" name = "id" required><br><br>
			Password:<br><input type = "password" name = "pw" required><br><br><br>
			<input type = "submit" name = "sia" value = "Log In">
		</form><br>
